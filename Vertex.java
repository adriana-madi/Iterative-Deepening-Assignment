...
public class Vertex implements Comparable<Vertex>
{
    ...
    // Since the of rectangles is square this will return a unique integer identifier for any vertex
	// allowing using of HashMap
    public int hashCode() {
    	return Integer.parseInt(String.format("%02d", x) + String.format("%02d", y));
	}
